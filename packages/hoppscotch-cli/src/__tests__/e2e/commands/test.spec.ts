...
describe("post test [options] <file_path_or_id>", { timeout: 100000 }, () => {
  const VALID_TEST_ARGS = `test ${getTestJsonFilePath("passes-coll.json", "collection")}`;

  describe("Test `post test <file_path_or_id>` command:", () => {
  ...
  describe("Test `post test <file_path_or_id> --env <file_path_or_id>` command:", () => {
  ...
  describe("Test `post test <file_path_or_id> --delay <delay_in_ms>` command:", () => {
    describe("Argument parsing", () => {
  ...
  describe.skip("Test `post test <file_path_or_id> --env <file_path_or_id> --token <access_token> --server <server_url>` command:", () => {
    const {
  ...
  describe("Test`post test <file_path_or_id> --env <file_path_or_id> --reporter-junit [path]", () => {
