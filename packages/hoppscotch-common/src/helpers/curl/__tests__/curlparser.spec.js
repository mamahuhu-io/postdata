...
const samples = [
  ...
  {
    command: `curl --get -I -d "tool=curl" -d "platform=hoppscotch" -d"io" https://postdata.cn`,
    response: makeRESTRequest({
      method: "HEAD",
      name: "Untitled",
      endpoint: "https://postdata.cn/?io",
      auth: {
        authActive: true,
        authType: "inherit",
      },
  ...
  {
    command: `curl 'https://postdata.cn/' \
