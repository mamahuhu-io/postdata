          ...
          <template #content="{ hide }">
            ...
            >
              ...
              <HoppSmartItem
                :icon="IconGithub"
                :label="`${t('app.github')}`"
                to="https://github.com/mamahuhu-io/postdata"
                blank
                @click="hide()"
              />
              <HoppSmartItem
              ...
              <HoppSmartItem
                ...
                to="https://docs.postdata.cn/support/privacy"
                blank
                @click="hide()"
              />
...
import { HoppSmartItem } from "@mamahuhu/ui"
...
const nativeShare = () => {
  if (navigator.share) {
    navigator
      .share({
        title: "Postdata",
        text: "Postdata • Open source API development ecosystem - Helps you create requests faster, saving precious time on development.",
