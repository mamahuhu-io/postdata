...
export const APP_INFO = {
  ...
  keywords:
    "postdata, post data, postdata app, postdata for mac, postdata app, postdata for windows, postdata google chrome, postdata chrome app, get postdata, postdata web, postdata android, postdata app for chrome, postdata mobile app, postdata web app, api, request, testing, tool, rest, websocket, sse, graphql, socketio",
  app: {
    background: "#181818",
